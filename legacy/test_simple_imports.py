...
def verify_backend_imports():
    ...
    try:
        ...
        print("OK: LLM Provider working")
        print(f"  Model: {info['name']}")
    except Exception as e:
        print(f"ERROR: LLM Provider error: {e}")
        return False
    ...
    try:
        ...
        print(f"WARNING: API router error (expected on Windows): {e}")
...
if __name__ == "__main__":
    ...
    if success:
        print("\nSUCCESS: Backend setup is working correctly!")
    else:
        print("\nFAILURE: Backend setup has issues!")
